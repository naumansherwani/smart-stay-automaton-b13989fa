...
const TOOL_GOOGLE_SYNC: CrmToolConfig = { id: "google-sync", label: "Google Sync", icon: "📧", description: "Sync Gmail, Calendar & Chat into your CRM" };
...
export const CRM_INDUSTRY_CONFIGS: Record<IndustryType, CrmIndustryConfig> = {
  hospitality: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_CALENDAR, TOOL_AI_PRICING, TOOL_MANUAL_BOOKING, TOOL_RESOURCE_MGMT],
  },
  airlines: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_AI_PRICING, TOOL_CAPACITY, TOOL_ROUTE_OPT],
  },
  car_rental: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_PRICING, TOOL_FLEET_MGMT, TOOL_MANUAL_BOOKING, TOOL_CAPACITY],
  },
  healthcare: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_MANUAL_BOOKING, TOOL_RESOURCE_MGMT],
  },
  education: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_MANUAL_BOOKING, TOOL_CAPACITY, TOOL_RESOURCE_MGMT],
  },
  logistics: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_ROUTE_OPT, TOOL_CAPACITY, TOOL_FLEET_MGMT, TOOL_AI_SCHEDULING],
  },
  events_entertainment: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_CALENDAR, TOOL_AI_PRICING, TOOL_MANUAL_BOOKING, TOOL_CAPACITY],
  },
  railways: {
    contactLabel: "Passenger", contactLabelPlural: "Passengers",
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_AI_PRICING, TOOL_ROUTE_OPT, TOOL_CAPACITY],
  },
  fitness_wellness: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_MANUAL_BOOKING, TOOL_CAPACITY],
  },
  legal_services: {
    contactLabel: "Client", contactLabelPlural: "Clients",
  ...
  real_estate: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_PRICING, TOOL_AI_SCHEDULING, TOOL_MANUAL_BOOKING, TOOL_RESOURCE_MGMT],
  },
  coworking: {
    contactLabel: "Member", contactLabelPlural: "Members",
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_PRICING, TOOL_AI_CALENDAR, TOOL_MANUAL_BOOKING, TOOL_RESOURCE_MGMT],
  },
  marine_maritime: {
    contactLabel: "Client", contactLabelPlural: "Clients",
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_ROUTE_OPT, TOOL_AI_SCHEDULING, TOOL_CAPACITY, TOOL_FLEET_MGMT],
  },
  government: {
    ...
    crmTools: [TOOL_SMART_TASKS, TOOL_DAILY_PLANNER, TOOL_GOOGLE_SYNC, TOOL_AI_SCHEDULING, TOOL_RESOURCE_MGMT, TOOL_CAPACITY],
  },
  travel_tourism: {
