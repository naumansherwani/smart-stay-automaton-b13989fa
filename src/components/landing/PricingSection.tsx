...
const PLANS = [
  {
    ...
    features: ["3 resources", "Limited bookings/appointments", "Limited AI Calendar", "Limited AI Pricing", "Calendar sync", "Double-booking guard", "Email notifications", "Basic analytics", "1 industry"],
  ...
  },
  {
    ...
    features: ["All Basic features +", "15 resources", "100 bookings/appointments", "Double-booking guard", "Unlimited AI Calendar", "Unlimited AI Pricing", "AI scheduling", "Guest/client scoring", "Advanced analytics", "Competitor radar", "Gap-filler engine", "Marketplace access", "Priority support"],
    cta: "Start Free Trial",
