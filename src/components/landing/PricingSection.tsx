...
const PLANS = [
  ...
  },
  {
    ...
    features: ["All Basic features +", "15 resources", "100 bookings/month", "AI smart pricing", "AI scheduling", "Guest/client scoring", "Advanced analytics", "Competitor radar", "Gap-filler engine", "Marketplace access", "Priority support"],
    cta: "Start Free Trial",
  ...
  },
  {
    ...
    features: ["All Pro features +", "Unlimited resources", "Unlimited bookings", "AI demand forecasting", "AI conflict resolution", "Revenue optimizer", "Dynamic route optimization", "White-label branding", "Multi-team management", "Custom AI training", "Dedicated account manager", "API access"],
    cta: "Start Free Trial",
    style: "border-border/50",
  },
];
