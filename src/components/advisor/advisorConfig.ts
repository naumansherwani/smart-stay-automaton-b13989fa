...
export const ADVISORS: Record<IndustryType, AdvisorConfig> = {
  ...
  events_entertainment: {
    ...
    auraHsl: "292 84% 61%",
    shortTitle: "Experience Director",
    resolutionPulse: true,
    placeholder: "What experience would you like to design, optimize, or monetize today?",
    starterPrompts: [
      "Optimize ticket pricing for maximum revenue.",
      "Analyze event demand trends.",
      "Increase VIP table sales.",
      "Build a sponsorship strategy.",
    ...
    toolPanels: [
      // Ticket Revenue
      { id: "vega_dynamic_pricing", category: "Ticket Revenue", label: "🎟️ Dynamic Ticket Pricing", icon: "DollarSign", prompt: "Recommend dynamic ticket pricing for the upcoming show based on demand curve, sell-through velocity and comparable events." },
      { id: "vega_vip_upsell", category: "Ticket Revenue", label: "🥂 VIP Upsell Optimization", icon: "Crown", prompt: "Identify high-value attendees and recommend VIP table, hospitality and meet-and-greet upsell opportunities for the next show." },
      { id: "vega_presale", category: "Ticket Revenue", label: "🎫 Presale Strategy", icon: "Ticket", prompt: "Design a presale waves strategy with pricing tiers, holds and fan-club access to maximize early revenue." },
      // Audience Growth
      { id: "vega_attendance_forecast", category: "Audience Growth", label: "📈 Attendance Forecasting", icon: "TrendingUp", prompt: "Forecast attendance and sell-through for the next 14 days by event, segment and channel; flag at-risk shows." },
      { id: "vega_social_sentiment", category: "Audience Growth", label: "📡 Social Sentiment Analysis", icon: "Activity", prompt: "Analyze audience sentiment and hype across Instagram, TikTok and YouTube for our current campaigns; surface viral moments and risks." },
      // Sponsorship
      { id: "vega_sponsorship_strategy", category: "Sponsorship", label: "🤝 Sponsorship Strategy", icon: "Handshake", prompt: "Build a sponsorship strategy for the upcoming tour: target brands, package tiers, activation ideas and projected revenue." },
      // Production Operations
      { id: "vega_production_cost", category: "Production Operations", label: "💡 Production Cost Control", icon: "Sparkles", prompt: "Review production costs across lighting, sound, staging and crew; recommend the top savings opportunities without hurting show quality." },
      { id: "vega_runbook", category: "Production Operations", label: "📋 Show Runbook Builder", icon: "CalendarClock", prompt: "Build a detailed run of show including cues, transitions, crew assignments and contingency steps for our next headline event." },
      { id: "vega_talent_sched", category: "Production Operations", label: "👥 Talent & Crew Scheduling", icon: "Users", prompt: "Schedule talent, crew and rehearsals for the next 7 days, factor travel and rest requirements, and flag conflicts." },
      // Guest Experience
      { id: "vega_guest_comm", category: "Guest Experience", label: "✉️ Guest Communication", icon: "Mail", prompt: "Draft personalised guest communications — pre-event hype, day-of logistics, post-event thank-you — segmented by ticket tier." },
      { id: "vega_riders", category: "Guest Experience", label: "🎤 Artist Rider Check", icon: "FileText", prompt: "Audit artist riders for tomorrow's show and flag any unmet hospitality, technical or contractual requirements." },
      // Strategic Planning
      { id: "vega_profitability", category: "Strategic Planning", label: "💰 Event Profitability Analysis", icon: "LineChart", prompt: "Run a full profitability analysis on recent and upcoming events: revenue mix, cost structure, margin drivers and scenario models." },
    ],
    metricBadges: [
      { id: "tickets_sold_pct", label: "Tickets Sold", endpoint: "/metrics/events_entertainment/tickets_sold_pct", unit: "%" },
      { id: "rev_per_attendee", label: "Rev/Attendee", endpoint: "/metrics/events_entertainment/revenue_per_attendee" },
      { id: "vip_conversion", label: "VIP Conv", endpoint: "/metrics/events_entertainment/vip_conversion_rate", unit: "%" },
      { id: "sponsor_revenue", label: "Sponsor Rev", endpoint: "/metrics/events_entertainment/sponsor_revenue" },
      { id: "audience_engagement", label: "Engagement", endpoint: "/metrics/events_entertainment/audience_engagement", unit: "%" },
      { id: "social_sentiment", label: "Sentiment", endpoint: "/metrics/events_entertainment/social_sentiment" },
      { id: "occupancy_rate", label: "Occupancy", endpoint: "/metrics/events_entertainment/occupancy_rate", unit: "%" },
      { id: "profit_margin", label: "Profit Margin", endpoint: "/metrics/events_entertainment/profit_margin", unit: "%" },
    ],
    channels: [
      ...
      { id: "email", label: "Email", icon: "Mail" },
      { id: "whatsapp", label: "WhatsApp", icon: "MessageCircle" },
      { id: "ai_crm", label: "AI CRM", icon: "Users" },
    ],
  },
  railways: {
    industry: "railways",
