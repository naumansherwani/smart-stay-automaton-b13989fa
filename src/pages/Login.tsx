  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-4 cursor-pointer" onClick={() => navigate("/")}>
          {/* Crown icon */}
          <div className="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500/20 via-yellow-500/15 to-orange-500/20 border border-amber-500/30 flex items-center justify-center animate-pulse shadow-[0_0_30px_rgba(245,158,11,0.15)]">
            <span className="text-3xl">👑</span>
          </div>

          <p className="text-xs font-medium tracking-[0.35em] uppercase text-amber-500/80">Royal Access</p>
          ...
          <div className="flex items-center justify-center gap-3">
            <span className="h-px w-16 bg-gradient-to-r from-transparent via-amber-500/40 to-transparent" />
            <span className="text-[10px] tracking-[0.3em] uppercase text-amber-500/60 font-semibold">Command Center</span>
            <span className="h-px w-16 bg-gradient-to-r from-transparent via-amber-500/40 to-transparent" />
          </div>
          <p className="text-sm text-muted-foreground">Welcome back, Your Majesty ✨</p>
        </div>

        <div className="bg-card/80 backdrop-blur-sm rounded-2xl border border-border/60 p-6 space-y-6 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.3)] relative overflow-hidden">
          {/* Subtle shimmer border */}
          <div className="absolute inset-0 rounded-2xl border border-amber-500/10 pointer-events-none" />
          
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" onClick={handleGoogle} className="w-full hover:border-primary/50 transition-colors">
            ...
            <Button variant="outline" onClick={handleApple} className="w-full hover:border-primary/50 transition-colors">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-gradient-primary h-11 text-sm font-semibold shadow-lg shadow-primary/20" disabled={loading}>
        ...
        <p className="text-center text-[11px] text-muted-foreground/50">
          The throne awaits. Command your empire with AI.
        </p>
      </div>
    </div>
  );
